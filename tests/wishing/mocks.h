...
boolean Can_fall_thru(d_level *l)
{
    return FALSE;
}
const char *align_str(ALIGNTYP_P alignment)
{
    return "unknown";
}

const char* artifact_name(const char *name, short *typ)
{
    return NULL;
}
...
const char* body_part(int typ)
{
    return "body_part";
}
int can_be_hatched(int typ)
{
    return typ;
}
void consume_oeaten(struct obj *obj, int amount) {}
boolean dead_species(int typ, BOOLEAN_P bool)
{
    return FALSE;
}
void del_engr_at(int x, int y) {}
void delete_contents(struct obj *obj) {}
int genus(int typ, int number)
{
    return 0;
}
boolean is_quest_artifact(struct obj *obj)
{
    return FALSE;
}
...
int title_to_mon(const char *str, int* number1, int* number2)
{
    return 0;
}

void obfree(struct obj *obj1, struct obj *obj2) {}
struct obj* oname(struct obj *obj, const char *str)
{
    return NULL;
}
boolean water_damage(struct obj * obj, BOOLEAN_P bool1, BOOLEAN_P bool2)
{
    return FALSE;
}
void reset_remarm() {}
...
boolean worm_known(struct monst *monst)
{
    return FALSE;
}
struct obj* which_armor(struct monst *monst, long number)
{
    return NULL;
}
int mon_has_amulet(struct monst *monst)
{
    return 0;
}
...
struct obj* mk_artifact(struct obj *obj, ALIGNTYP_P typ)
{
    return NULL;
}
//E const char *FDECL(artifact_name, (const char *,short *));
boolean exist_artifact(int typ, const char *str)
{
    return FALSE;
}
...
boolean defends(int number1, struct obj *obj)
{
    return FALSE;
}
boolean protects(int number2, struct obj *obj)
{
    return FALSE;
}
...
boolean undiscovered_artifact(XCHAR_P typ)
{
    return FALSE;
}
...
boolean MATCH_WARN_OF_MON(struct monst *monst)
{
    return FALSE;
}
...
char* mon_nam(struct monst *monst)
{
    return "mon_nam";
}
...
//#endif
struct obj* realloc_obj(struct obj *obj, int number1, genericptr_t generic, int number2, const char *str)
{
    return NULL;
}
...
boolean In_quest(d_level *level)
{
    return FALSE;
}
...
//E void NDECL(vomit);
int eaten_stat(int number1, struct obj *obj)
{
    return 0;
}
...
char* in_rooms(XCHAR_P x, XCHAR_P y, int number)
{
    return NULL;
}
...
/* ### invent.c ### */
int merged(struct obj **obj1, struct obj **obj2)
{
    return 0;
}
const char* currency(long number)
{
    return "currency";
}
...
boolean prohibited_by_generation_flags(struct permonst *permonst)
{
    return FALSE;
}
...
int undead_to_corpse(int number)
{
    return NON_PM;
}
...
struct monst* shop_keeper(CHAR_P c)
{
    return NULL;
}
...
long contained_cost(struct obj *obj, struct monst *monst, long number, BOOLEAN_P bool1, BOOLEAN_P bool2)
{
    return 0;
}
//E long FDECL(contained_gold, (struct obj *));
//E void FDECL(picked_container, (struct obj *));
long unpaid_cost(struct obj *obj)
{
    return 0;
}
...
boolean is_fshk(struct monst *monst)
{
    return FALSE;
}
//E void FDECL(shopdig, (int));
//E void FDECL(pay_for_damage, (const char *,BOOLEAN_P));
boolean costly_spot(XCHAR_P x, XCHAR_P y)
{
    return FALSE;
}
...
boolean start_timer(long timeleft, SHORT_P typ, SHORT_P action, genericptr_t generic)
{
    return TRUE;
}
long stop_timer(SHORT_P typ, genericptr_t generic)
{
    return 0;
}
...
struct obj* tt_oname(struct obj *obj)
{
    return NULL;
}
...
boolean get_obj_location(struct obj *obj, xchar *x, xchar *y, int number)
{
    return FALSE;
}
