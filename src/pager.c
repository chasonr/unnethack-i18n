...
dohelp(void)
{
    ...
    if (help_menu(&sel)) {
        switch (sel) {
        case  0:
            display_file_area(NH_HELP_AREA, HELP, TRUE);
            break;
        case  1:
            display_file_area(NH_SHELP_AREA, SHELP, TRUE);
            break;
        case  2:
            (void) dohistory();
            break;
        ...
        case  5:
            ...
            break;
        case  6:
            display_file_area(NH_OPTIONAREA, OPTIONFILE, TRUE);
            break;
        case  7:
            (void) doextlist();
            break;
        case  8:
            display_file_area(NH_LICENSE_AREA, LICENSE, TRUE);
            break;
        case  9:
            tutorial_redisplay();
            break;
        ...
        default:
            display_file_area(NH_DEBUGHELP_AREA, DEBUGHELP, TRUE);
            break;
#endif
#ifdef PORT_HELP
        case PORT_HELP_ID:
