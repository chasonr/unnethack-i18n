...
void
new_light_source(xchar x, xchar y, int range, int type, genericptr_t id)
{
    light_source *ls;
 ...
 */
void
del_light_source(int type, genericptr_t id)
{
    ...
    switch (type) {
    case LS_OBJECT:
        tmp_id = (genericptr_t)(((struct obj *)id)->o_id);
        break;
    case LS_MONSTER:
        tmp_id = (genericptr_t)(((struct monst *)id)->m_id);
        break;
    default:
        tmp_id = 0;
        break;
