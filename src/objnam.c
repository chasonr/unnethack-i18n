 ...
 */
char *
distant_name(register struct obj *obj, char *(*func) (struct obj *))
{
    char *str;
...
char *
corpse_xname(struct obj *otmp, boolean ignore_oquan)
 ...
 */
struct obj *
readobjnam(register char *bp, struct obj *no_wish, boolean from_user)
{
    register char *p;
    register int i;
