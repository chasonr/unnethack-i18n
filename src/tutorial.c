...
int oclass;
{
    switch(oclass) {
    case WEAPON_CLASS:
        check_tutorial_message(QT_T_ITEM_WEAPON);
        return 1;
    case FOOD_CLASS:
        check_tutorial_message(QT_T_ITEM_FOOD);
        return 1;
    case GEM_CLASS:
        check_tutorial_message(QT_T_ITEM_GEM);
        return 1;
    case TOOL_CLASS:
        check_tutorial_message(QT_T_ITEM_TOOL);
        return 1;
    case AMULET_CLASS:
        check_tutorial_message(QT_T_ITEM_AMULET);
        return 1;
    case POTION_CLASS:
        check_tutorial_message(QT_T_ITEM_POTION);
        return 1;
    case SCROLL_CLASS:
        check_tutorial_message(QT_T_ITEM_SCROLL);
        return 1;
    case SPBOOK_CLASS:
        check_tutorial_message(QT_T_ITEM_BOOK);
        return 1;
    case ARMOR_CLASS:
        check_tutorial_message(QT_T_ITEM_ARMOR);
        return 1;
    case WAND_CLASS:
        check_tutorial_message(QT_T_ITEM_WAND);
        return 1;
    case RING_CLASS:
        check_tutorial_message(QT_T_ITEM_RING);
        return 1;
    case ROCK_CLASS:
        check_tutorial_message(QT_T_ITEM_STATUE);
        return 1;
    case COIN_CLASS:
        check_tutorial_message(QT_T_ITEM_GOLD);
        return 1;
    default:
        return 0; /* venom/ball/chain/mimic don't concern us */
    }
}
