 ...
 */
STATIC_OVL boolean
mon_has_arti(register struct monst *mtmp, register short int otyp)
{
    register struct obj *otmp;
...
other_mon_has_arti(register struct monst *mtmp, register short int otyp)
{
