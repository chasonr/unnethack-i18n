...
STATIC_OVL void
check_shop_obj(register struct obj *obj, register xchar x, register xchar y, register boolean broken)
{
...
void
throwit(register struct obj *obj, long int wep_mask, boolean twoweap)
