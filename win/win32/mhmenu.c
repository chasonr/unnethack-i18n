...
COLORREF nhcolor_to_RGB(int c)
{
    ...
    case CLR_GREEN:
        return RGB(0x00, 0x60, 0x00);
    case CLR_BROWN:
        return RGB(0x80, 0x00, 0x00);
    case CLR_BLUE:
        return RGB(0x20, 0x20, 0xA0);
    case CLR_MAGENTA:
        return RGB(0xA0, 0x00, 0xA0);
    case CLR_CYAN:
    ...
    case CLR_YELLOW:
        return RGB(0xC0, 0xC0, 0x00);
    case CLR_BRIGHT_BLUE:
        return RGB(0x40, 0x40, 0xFF);
    case CLR_BRIGHT_MAGENTA:
        return RGB(0xFF, 0x00, 0xFF);
    case CLR_BRIGHT_CYAN:
        return RGB(0x00, 0xC0, 0xC0);
    case CLR_WHITE:
        return RGB(0x90, 0x90, 0x90);
    default:
...
void SetMenuListType(HWND hWnd, int how)
{
    ...
    for(i=0; i<data->menu.size; i++ ) {
        ...
        SendMessage(control, LB_ADDSTRING, (WPARAM)0, (LPARAM) buf);
