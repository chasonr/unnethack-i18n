...
/*ARGSUSED*/
static void
invert_line(struct xwindow *wp, x11_menu_item *curr, int which, long int how_many)
{
...
/*ARGSUSED*/
void
X11_add_menu(winid window, int glyph, int cnt, const anything *identifier, char ch, char gch, int attr, const char *str, boolean preselected)
...
#define GSELIDX(c) ((c) & 127)	/* guard against `signed char' */
    ...
    *ptr = 0;		/* terminate list with null */
    ...
    if (!menu_info->valid_widgets) {
        ...
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        num_args++;
        XtSetArg(args[num_args], XtNbottom, XtChainTop);
        num_args++;
        ...
        XtSetArg(args[num_args], XtNfromVert, label);
        num_args++;
        XtSetArg(args[num_args], XtNfromHoriz, ok);
        num_args++;
        XtSetArg(args[num_args], XtNsensitive, how!=PICK_NONE);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        num_args++;
        XtSetArg(args[num_args], XtNbottom, XtChainTop);
        ...
        XtSetArg(args[num_args], XtNfromVert, label);
        num_args++;
        XtSetArg(args[num_args], XtNfromHoriz, cancel);
        num_args++;
        XtSetArg(args[num_args], XtNsensitive, sens);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        num_args++;
        XtSetArg(args[num_args], XtNbottom, XtChainTop);
        ...
        XtSetArg(args[num_args], XtNfromVert, label);
        num_args++;
        XtSetArg(args[num_args], XtNfromHoriz, all);
        num_args++;
        XtSetArg(args[num_args], XtNsensitive, sens);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        ...
        XtSetArg(args[num_args], XtNfromVert, label);
        num_args++;
        XtSetArg(args[num_args], XtNfromHoriz, none);
        num_args++;
        XtSetArg(args[num_args], XtNsensitive, sens);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        ...
        XtSetArg(args[num_args], XtNfromVert, label);
        num_args++;
        XtSetArg(args[num_args], XtNfromHoriz, invert);
        num_args++;
        XtSetArg(args[num_args], XtNsensitive, how!=PICK_NONE);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        ...
        num_args++;
        XtSetArg(args[num_args], XtNallowHoriz, False);
        num_args++;
        XtSetArg(args[num_args], XtNuseBottom, True);
        num_args++;
        XtSetArg(args[num_args], XtNuseRight, True);
        num_args++;
        /*
        	XtSetArg(args[num_args], XtNforceBars, True);		num_args++;
        */
        XtSetArg(args[num_args], XtNfromVert, all);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        num_args++;
        XtSetArg(args[num_args], XtNbottom, XtChainBottom);
        num_args++;
        XtSetArg(args[num_args], XtNleft, XtChainLeft);
        num_args++;
        ...
        num_args = 0;
        XtSetArg(args[num_args], XtNforceColumns, True);
        num_args++;
        XtSetArg(args[num_args], XtNcolumnSpacing, 1);
        num_args++;
        XtSetArg(args[num_args], XtNdefaultColumns, 1);
        num_args++;
        ...
        num_args++;
        XtSetArg(args[num_args], XtNrowSpacing, &row_spacing);
        num_args++;
