...
void X11_resume_nhwindows()
{
    return;
}

/* ARGSUSED */
void X11_suspend_nhwindows(str) const char *str;
{
    return;
}
...
/* ARGSUSED */
void X11_number_pad(state) int state;
{
    return;    /* called from options.c */
}


void X11_start_screen()
{
