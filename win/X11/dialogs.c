...
CreateDialog(Widget parent, String name, XtCallbackProc okay_callback, XtCallbackProc cancel_callback)
{
...
#ifdef SPECIAL_CMAP
    if (special_cmap) {
        XtSetArg(args[num_args], XtNbackground, white);
        num_args++;
    }
#endif
...
#ifdef SPECIAL_CMAP
    if (special_cmap) {
        XtSetArg(args[num_args], XtNforeground, black);
        num_args++;
        XtSetArg(args[num_args], XtNbackground, white);
        num_args++;
    }
...
#endif
    XtSetArg(args[num_args], XtNfromVert, prompt);
    num_args++;
    XtSetArg(args[num_args], XtNtop, XtChainTop);
    num_args++;
    XtSetArg(args[num_args], XtNbottom, XtChainTop);
...
#endif
    XtSetArg(args[num_args], XtNfromVert, response);
    num_args++;
    XtSetArg(args[num_args], XtNtop, XtChainTop);
    num_args++;
    XtSetArg(args[num_args], XtNbottom, XtChainTop);
    ...
    if (cancel_callback) {
        ...
        XtSetArg(args[num_args], XtNfromVert, response);
        num_args++;
        XtSetArg(args[num_args], XtNfromHoriz, okay);
        num_args++;
        XtSetArg(args[num_args], XtNtop, XtChainTop);
        num_args++;
        XtSetArg(args[num_args], XtNbottom, XtChainTop);
