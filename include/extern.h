...
E void FDECL(set_uhpmax, (int,boolean));
...
E boolean FDECL(bad_location, (xchar,xchar,xchar,xchar,xchar,xchar,xchar));
E int FDECL(place_lregion, (xchar,xchar,xchar,xchar,
...
E boolean FDECL(bydoor, (xchar,xchar));
...
E void FDECL(bill_box_content, (struct obj *,boolean));
...
E void FDECL(bars_around_portal, (boolean));
#endif /* BLACKMARKET */
...
E void FDECL(erode_obj, (struct obj *,boolean,boolean));
